...
class MossAudioEncoder(nn.Module):
    ...
    def _encode_chunk_batch(
        ...
        for layer_idx, layer in enumerate(self.layers):
            layer_out = layer(x, attention_mask)  # transformers<5 returns a tuple, >=5 a tensor
    ...
    def prepare_inputs_for_generation(
        ...
        **kwargs,
        ...
        if cache_position is not None:
            ...
            try:  # transformers >= 5 may not pass cache_position to custom prepare_inputs_for_generation
